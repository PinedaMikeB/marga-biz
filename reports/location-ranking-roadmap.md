...
1. add a second support article for each city with distinct intent
2. collect real local proof and testimonials where available
3. turn each money page and first support article into slide-video assets
